...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_X_NUCLEO_IKS01A2, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSL_TRIGGER_OWN_THREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSL_TRIGGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSL_THREAD_PRIORITY, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSL_THREAD_STACK_SIZE, 1024);
